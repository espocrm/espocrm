...
<div class="link-group-container hidden">
    ...
    <div class="input-group add-team">
        ...
        <span class="input-group-btn">
            <button data-action="selectLink" class="btn btn-default btn-icon btn-sm" type="button" tabindex="-1" title="{{translate 'Select'}}"><span class="fas fa-caret-up"></span></button>
        </span>
    </div>
