...
<div class="one-of-container hidden">
    ...
    <div class="input-group add-team">
        ...
        <span class="input-group-btn">
            <button data-action="selectLinkOneOf" class="btn btn-default btn-sm btn-icon" type="button" tabindex="-1" title="{{translate 'Select'}}"><span class="glyphicon glyphicon-arrow-up"></span></button>
        </span>
    </div>
</div>
