...
<div class="input-group">
    <input class="main-element form-control" type="text" name="{{name}}" value="{{date}}" autocomplete="espo-{{name}}">
    <span class="input-group-btn">
        <button type="button" class="btn btn-default btn-icon date-picker-btn" tabindex="-1"><i class="far fa-calendar"></i></button>
    </span>
    <input class="form-control" type="text" name="{{name}}-time" value="{{time}}" autocomplete="espo-{{name}}">
    <span class="input-group-btn">
