define("handlers/currency-record/record-detail", ["exports"], function (_exports) {
  "use strict";
  ...
  class CurrencyRecordRecordDetailHandler {
    /**
  ...
  _exports.default = CurrencyRecordRecordDetailHandler;
});
