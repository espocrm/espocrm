    ...
    \Doctrine\DBAL\Schema\Comparator
{
    ...
    public function diffColumn(Column $column1, Column $column2)
    {
        ...
        if ($column1->getType() != $column2->getType()) {
            ...
            $column1DbTypeName = method_exists($column1->getType(),
                'getDbTypeName') ? $column1->getType()->getDbTypeName() : $column1->getType()->getName();
            $column2DbTypeName = method_exists($column2->getType(),
                'getDbTypeName') ? $column2->getType()->getDbTypeName() : $column2->getType()->getName();
        ...
        if ($column1->getType() instanceof StringType) {
        ...
        if ($column1->getType() instanceof DecimalType) {
