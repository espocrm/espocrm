...
use Espo\Core\Cron\Service;
use Espo\Core\Utils\Config;
use Espo\Core\Utils\File\Manager;
use Espo\Core\Utils\Log;
use Espo\Services\Job;
...
class CronManager
{
    ...
    public function __construct(Container $container)
    {
        ...
        $this->serviceCron = new Service($this->container->get('serviceFactory'));
        $serviceFactory = $this->container->get('serviceFactory');
        $this->jobService = $serviceFactory->create('job');
        $this->scheduledJobService = $serviceFactory->create('scheduledJob');
    }
