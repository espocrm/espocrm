...
<div class="row">
	<div class="col-sm-6">
		<div class="cell cell-type form-group">
			<label class="control-label">{{translate 'type' scope='Admin' category='fieldParams'}}</label>
			<div class="field field-type">{{translate type scope='Admin' category='fieldTypes'}}</div>
		</div>
		<div class="cell cell-name form-group">
			<label class="control-label">{{translate 'name' scope='Admin' category='fieldParams'}}</label>
			<div class="field field-name">{{{name}}}</div>
		</div>
		<div class="cell cell-label form-group">
			<label class="control-label">{{translate 'label' scope='Admin' category='fieldParams'}}</label>
