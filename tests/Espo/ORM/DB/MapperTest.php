...
require_once BP . '/tests/testData/DB/Entities.php';
require_once BP . '/tests/testData/DB/MockPDO.php';
require_once BP . '/tests/testData/DB/MockDBResult.php';

class DBMapperTest extends
