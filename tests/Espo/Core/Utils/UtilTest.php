    ...
    \PHPUnit_Framework_TestCase
{
    ...
    public function testConcatPath()
    {
        ...
        $result = Util::fixPath('dir1/dir2/file2.json');
        $this->assertEquals($result, Util::concatPath('dir1/dir2/', 'file2.json'));
        $result = Util::fixPath('dir1/dir2/file3.json');
        $this->assertEquals($result, Util::concatPath('dir1/dir2/file3.json'));
        $input = array('dir1/dir2', 'file4.json');
        $result = Util::fixPath('dir1/dir2/file4.json');
        $this->assertEquals($result, Util::concatPath($input));
        $input = array('dir1/', 'dir2', 'file5.json');
        $result = Util::fixPath('dir1/dir2/file5.json');
        $this->assertEquals($result, Util::concatPath($input));
    }
    ...
    {
        $this->assertEquals('\Espo\EntryPoints\Donwload',
            Util::getClassName('application/Espo/EntryPoints/Donwload.php'));
