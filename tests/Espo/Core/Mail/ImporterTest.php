...
class ImporterTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testImport1()
    {
        ...
        $emailDefs = require('tests/testData/Core/Mail/email_defs.php');
        $email->fields = $emailDefs['fields'];
        $email->relations = $emailDefs['relations'];

        $attachment = new \Espo\Entities\Attachment();
        $attachmentDefs = require('tests/testData/Core/Mail/attachment_defs.php');
        ...
        $contents = file_get_contents('tests/testData/Core/Mail/test_email_1.eml');
